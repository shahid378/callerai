export default {
    ...
    getters:{
        ...
        getMonthlyTextPlanCards(state){
            return state.monthlyPlanCards
        },
        getYearlyTextPlanCards(state){
            return state.yearlyPlanCards;
        },
        getAPIData(state){
            return state.APIDataForUser;
        },
    },
    mutations:{
        ...
        setTextPlansData(state,params){
            state.monthlyTextPlanCards = params.monthlyTextPlanCards;
            state.yearlyTextPlanCards = params.yearlyTextPlanCards;
        },
        setAPIsDataForUser(state,params){
            state.APIDataForUser = params;
        },
    },
    actions:{
        getAPIsDataForUser({commit}){
            let params = [{
                'key':'231',
                'createdDate': '231213',
                'status': 'Active',                
            }];            
            commit('setAPIsDataForUser', params);
        },
        getPlansData({commit}){
        ...
        getTextPlansData({commit}){
            let monthlyTextPlanCardsArr=[
                {
                    id:1,
                    name:'Starter',
                    badgeText:'',
            ...
            let params={
                monthlyTextPlanCards: monthlyTextPlanCardsArr,
                yearlyTextPlanCards: yearlyTextPlanCardsArr,
            }
            commit('setTextPlansData', params);
        },
    }
}