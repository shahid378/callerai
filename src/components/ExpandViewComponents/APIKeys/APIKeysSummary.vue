  ...
  <div class="disp-block h-100 y-scroller">
    <el-card class="box-card editone-view-card">
      ...
      <div class="disp-col-wise h-100 y-scroller">
        <div class="disp-col-wise">          
          <el-table :data="getAPIData" style="width: 100%">
    ...
    <el-card class="box-card editone-view-card m-b-25">
      ...
      <template #footer>
            <div class="disp-flex place-end">
              <el-button type="info" @click="saveTwillioAPI()">Save</el-button>
            </div>
      </template>
    </el-card>
    <el-card class="box-card editone-view-card">
      ...
      <template #header>
        <div class="card-header">
            <div class="disp-bw">
              <h3>OpenAI</h3>
              <div>
              <el-switch v-model="openAIFlag" /> <span>{{openAIFlag?'Enabled' : 'Disabled'}}</span></div>
            </div>
        </div>
      </template>
      <div class="disp-col-wise h-100 y-scroller">
      ...
      <template #header>
        <div class="card-header">
            <div class="disp-bw">
              <h3>Anthropic</h3>
              <div>
              <el-switch v-model="anthropicFlag" /> <span>{{anthropicFlag?'Enabled' : 'Disabled'}}</span></div>
            </div>
        </div>
      </template>
      <div class="disp-col-wise h-100 y-scroller">
